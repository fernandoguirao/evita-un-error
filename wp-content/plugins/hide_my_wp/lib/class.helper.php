...
/* Not really used currently
        ...
        function update_pp_important_messages() {
            ...
            $url = 'htt'.'p:/'.'/api.wpwave.com/important_message.php?site='.urlencode(str_replace('htt'.'p:/'.'/','',home_url())).'&theme='.$theme.'&wp_ver='.$wp_version.'&plugin='.$this->slug.'&ver='.$this->ver.'&li='.$li.'&posts='.$posts->publish;
