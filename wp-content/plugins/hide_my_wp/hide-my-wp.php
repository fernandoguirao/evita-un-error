...
// is_admin to set roles/ //fixed lost password link
// td: woocommerce authors/ remove case senstive www https from wp-conten removed site url domains / new admin path in nginx / paths in different domain by wpml
